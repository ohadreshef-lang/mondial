...
const TRANSLATIONS = {
    he: {
        ...
        'login.googleBtn': 'כניסה עם Google',
        'login.errorCancelled': 'הכניסה בוטלה',
        ...
        'tournament.subtitle': '10 נקודות לכל ניחוש נכון. נסגר יום שני 15/6 בשעה 20:00.',
        ...
        'groupSettings.logoLabel': 'לוגו הקבוצה',
        'groupSettings.logoUpload': 'העלה לוגו',
        'groupSettings.logoRemove': 'הסר לוגו',
        'groupSettings.logoNotImage': 'הקובץ אינו תמונה תקינה',
        'groupSettings.logoError': 'שגיאה בהעלאת הלוגו',
        ...
        'admin.noGroups': 'לא חבר באף קבוצה',
        'admin.tabMatches': 'משחקים',
        'admin.tabUsers': 'משתמשים',
        'admin.tabTournament': 'טורניר',
        'admin.tabGroups': 'קבוצות',
        'admin.groupsTitle': '👨‍👩‍👧 ניהול קבוצות',
        'admin.noGroupsYet': 'עדיין לא נוצרו קבוצות',
        'admin.groupOwner': 'מנהל',
        'admin.groupCode': 'קוד',
        'admin.groupsMembers': 'חברים',
        'admin.deleteGroupConfirm': (name) => `למחוק את הקבוצה "${name}"? פעולה זו תמחק את כל הניחושים בה ותוסר מכל החברים.`,
    ...
    en: {
        ...
        'login.errorCancelled': 'Sign-in cancelled',
        ...
        'tournament.subtitle': '10 points per correct prediction. Locks Monday 15/6 at 20:00.',
        ...
        'groupSettings.logoLabel': 'Group logo',
        'groupSettings.logoUpload': 'Upload logo',
        'groupSettings.logoRemove': 'Remove logo',
        'groupSettings.logoNotImage': 'File is not a valid image',
        'groupSettings.logoError': 'Error uploading logo',
        ...
        'admin.noGroups': 'Not in any group',
        'admin.tabMatches': 'Matches',
        'admin.tabUsers': 'Users',
        'admin.tabTournament': 'Tournament',
        'admin.tabGroups': 'Groups',
        'admin.groupsTitle': '👨‍👩‍👧 Groups management',
        'admin.noGroupsYet': 'No groups created yet',
        'admin.groupOwner': 'Owner',
        'admin.groupCode': 'Code',
        'admin.groupsMembers': 'members',
        'admin.deleteGroupConfirm': (name) => `Delete group "${name}"? This will erase all of its bets and remove it from every member.`,
    ...
    es: {
        ...
        'login.emailLabel': 'Email',
        'login.googleBtn': 'Entrar con Google',
        'login.errorCancelled': 'Inicio de sesión cancelado',
        ...
        'tournament.subtitle': '10 puntos por predicción correcta. Se cierra el lunes 15/6 a las 20:00.',
        ...
        'groupSettings.logoLabel': 'Logo del grupo',
        'groupSettings.logoUpload': 'Subir logo',
        'groupSettings.logoRemove': 'Quitar logo',
        'groupSettings.logoNotImage': 'El archivo no es una imagen válida',
        'groupSettings.logoError': 'Error al subir el logo',
        ...
        'admin.noGroups': 'Sin grupos',
        'admin.tabMatches': 'Partidos',
        'admin.tabUsers': 'Usuarios',
        'admin.tabTournament': 'Torneo',
        'admin.tabGroups': 'Grupos',
        'admin.groupsTitle': '👨‍👩‍👧 Gestión de grupos',
        'admin.noGroupsYet': 'Aún no hay grupos',
        'admin.groupOwner': 'Admin',
        'admin.groupCode': 'Código',
        'admin.groupsMembers': 'miembros',
        'admin.deleteGroupConfirm': (name) => `¿Eliminar el grupo "${name}"? Se borrarán todas sus apuestas y se quitará a todos los miembros.`,
